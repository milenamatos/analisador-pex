      ...
      <section ref="pdf-content">
        <cv-grid fullWidth class="result">
          ...
          <cv-tile fullWidth class="details text-justify">
            ...
            <p>
              A metodologia utiliza métodos de gestão estratégica e sustentável estruturados pelo modelo <em>Balanced Scorecard</em> (BSC) aliado ao modelo <em>Triple Bottom Line (TBL)</em>. A partir desses modelos, apresenta-se uma ferramenta que possibilita avaliar preliminarmente o tipo de relação existente entre os projetos e programas de Extensão Universitária (com base em suas características e seleção de indicadores FORPROEX) e os ODS por meio de gráficos e tabelas. A união de metodologias como o BSC e o TBL tem o objetivo de atender à crescente demanda por estratégias que combinem meio ambiente, sociedade e questões éticas com formas de medir o desempenho sustentável no ambiente corporativo utilizando estratégias de avaliação que combinam mais de um <em>framework</em>. 
            </p>
            <p>              
              O mapa estratégico sobre pesquisa universitária utilizado pelo FORPROEX incorporou a metodologia empregada pelo modelo BSC utilizando os 52 indicadores da avaliação da Extensão Universitária e adaptando os quatro quadrantes tradicionais do modelo para quadrantes que representam as seguintes perspectivas: <strong>Do Aluno, da Sociedade e dos Financiadores Públicos; Dos Processos Internos; Da Aprendizagem e Crescimento; Dos Recursos Financeiros e Infraestrutura </strong>. E para incorporação do método TBL, a autora do mestrado na qual esta ferramenta se baseia, distribuiu os ODS nos pilares definidos pelo mesmo, são eles: <strong>Sociocultural, Meio Ambiente e Econômico.</strong>
            </p>
            <p>
              Desta forma foi definida a metodologia híbrida de cruzamento entre o BSC e o TBL: uma matriz de cruzamento 52 x 17, denominada Matriz de Referência, apresenta os Indicadores de Extensão Universitária do FORPROEX nas linhas, distribuídos de acordo com os quadrantes do BSC, e nas colunas os ODS distribuídos dentro dos pilares de sustentabilidade do modelo TBL. Com base nessa Matriz são realizados cruzamentos e análises para aferir a aderência de um programa ou projeto de extensão aos ODS com base nos dados informados (informações de entrada) para o projeto analisado.
            </p>
          </cv-tile>
